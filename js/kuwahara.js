(function (imageproc) {
    ...
    imageproc.kuwahara = function (inputData, outputData, size) {
         ...
         * appropriate changes
         */
        var rangeInKernelSize = (Math.trunc(size / 2) + 1);
        var halfRangeInKernelSize = Math.trunc(rangeInKernelSize / 2);
        ...
        function regionStat(x, y) {
            ...
            var meanValue = 0;
            for (var j = -halfRangeInKernelSize; j <= halfRangeInKernelSize; j++) {
                for (var i = -halfRangeInKernelSize; i <= halfRangeInKernelSize; i++) {
            ...
            meanR /= (rangeInKernelSize * rangeInKernelSize);
            meanG /= (rangeInKernelSize * rangeInKernelSize);
            meanB /= (rangeInKernelSize * rangeInKernelSize);
            meanValue /= (rangeInKernelSize * rangeInKernelSize);
            ...
            variance /= (rangeInKernelSize * rangeInKernelSize);
        ...
        for (var y = 0; y < inputData.height; y++) {
            for (var x = 0; x < inputData.width; x++) {
                ...
                var regionA = regionStat(x - halfRangeInKernelSize, y - halfRangeInKernelSize, inputData);
                var regionB = regionStat(x + halfRangeInKernelSize, y - halfRangeInKernelSize, inputData);
                var regionC = regionStat(x - halfRangeInKernelSize, y + halfRangeInKernelSize, inputData);
                var regionD = regionStat(x + halfRangeInKernelSize, y + halfRangeInKernelSize, inputData);
