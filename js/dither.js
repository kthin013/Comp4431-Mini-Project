(function (imageproc) {
    ...
    imageproc.dither = function (inputData, outputData, matrixType) {
        ...
        /* TODO: You need to extend the dithering processing technique to include multiple matrix types */
        ...
        for (var y = 0; y < inputData.height; y++) {
            for (var x = 0; x < inputData.width; x++) {
                ...
                outputData.data[i] = outputData.data[i + 1] = outputData.data[i + 2] = (value < threshold) ? 0 : 255;
            }
        }
    }
